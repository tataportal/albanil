...
function runComplaintTests(): array {
    ...
    query('DROP TEMPORARY TABLE complaints');query('DROP TEMPORARY TABLE complaint_sequence');return array_merge($passed,['idempotent retry','conflict rejection','consecutive sequence','no production records created']);
}
